...
| 03-02-01 | 02 | 1 | AGNT-01 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_all_placeholders_filled -v` | ❌ W0 | ⬜ pending |
| 03-02-02 | 02 | 1 | AGNT-03 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_all_fields_have_review_notes -v` | ❌ W0 | ⬜ pending |
| 03-02-03 | 02 | 1 | AGNT-03 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_review_notes_cite_evidence -v` | ❌ W0 | ⬜ pending |
| 03-02-04 | 02 | 1 | AGNT-04 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_worst_case_before_base_case -v` | ❌ W0 | ⬜ pending |
| 03-02-05 | 02 | 1 | AGNT-04 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_bear_before_bull -v` | ❌ W0 | ⬜ pending |
| 03-03-01 | 03 | 2 | AGNT-01 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_with_sector_knowledge -v` | ❌ W0 | ⬜ pending |
| 03-03-02 | 03 | 2 | AGNT-02 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_finalization_transitions_llm_draft -v` | ❌ W0 | ⬜ pending |
| 03-03-03 | 03 | 2 | AGNT-05 | unit | `python -m unittest tests.test_analyst.TestAnalystAgent.test_enriched_codex_fields_present -v` | ❌ W0 | ⬜ pending |
