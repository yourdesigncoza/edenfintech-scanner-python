...
- [x] **SECT-03**: Gemini grounded search integration (8 queries per sub-sector via google-genai SDK)
...
- [x] **SECT-05**: CLI commands `hydrate-sector` and `sector-status`
